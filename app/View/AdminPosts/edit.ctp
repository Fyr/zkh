...
<?
    echo $this->element('AdminUI/form_title', array('title' => ($id) ? 'Редактировать публикацию' : 'Создать публикацию'));
    ...
    $tabs = array(
        __('General') => $this->Html->div('form-body',
            ...
            .$this->PHForm->input('teaser', array('label' => array('class' => 'col-md-3 control-label', 'text' => 'Текст')))
        ),
